...
eqs : [
{"step":1,"code":"\\frac{1}{\\sqrt{2}}","time":0},
{"step":2,"code":"E=mc^2","time":2},
{"step":3,"code":"\\sum_{n=1}^{\\infty} \\frac{1}{n^2} = \\frac{\\pi^2}{6}","time":4},
{"step":4,"code":"\\int_{0}^{\\pi} \\sin(x) dx = 2","time":6},
{"step":5,"code":"\\lim_{x \\to 0} \\frac{\\sin(x)}{x} = 1","time":8},{"step":6,"code":"\\sqrt{a^2 + b^2}","time":10},
{"step":7,"code":"F = G\\frac{m_1m_2}{r^2}","time":12},
{"step":8,"code":"\\binom{n}{k} = \\frac{n!}{k!(n-k)!}","time":14},
{"step":9,"code":"\\frac{d}{dx}e^x = e^x","time":16},
{"step":10,"code":"\\vec{F} = m\\vec{a}","time":18}
],
