...
<div class="flex flex-col w-full">
    <table class="border-collapse border-2 border-white">
        ...
        <tr>
            ...
            <td class="border border-white p-1">
                <input type="number" bind:value={item.radius} class="bg-gray-900 text-white p-1" placeholder="Radius">
            </td>
        </tr>
        <tr>
            <td class="border border-white p-1">starting Angle</td>
            <td class="border border-white p-1">
                <input type="number" bind:value={item.startAngle} class="bg-gray-900 text-white p-1" >
            </td>
        </tr>
        <tr> 
            <td class="border border-white p-1">Ending Angle</td>
            <td class="border border-white p-1">
