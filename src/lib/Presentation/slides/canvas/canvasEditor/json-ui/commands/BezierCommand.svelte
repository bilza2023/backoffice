...
<div class="flex flex-col w-full">
    <table class="border-collapse border-2 border-white">
        ...
        <tr>
            ...
            <td class="border border-white p-1">
                <input type="number" bind:value={item.x} class="bg-gray-900 text-white p-1" placeholder="X1">
            </td>
        </tr>
        <tr>
            <td class="border border-white p-1">Y</td>
            <td class="border border-white p-1">
                <input type="number" bind:value={item.y} class="bg-gray-900 text-white p-1" placeholder="Y1">
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="border border-white p-1">Handle</td>
            <td class="border border-white p-1">
                <input type="checkbox" bind:checked={item.showHandle} class="bg-gray-900 text-white p-1">
            </td>
        </tr>
        <tr>
