...
export declare function createContextMenu(props?: CreateContextMenuProps): {
    ...
    elements: {
        ...
        overlay: import("../../internal/helpers/index.js").MeltElement<[Readable<boolean>], <Node_1 extends any>(node: HTMLElement) => {
            destroy(): void;
        }, ([$isVisible]: [boolean]) => {
            readonly hidden: true | undefined;
            readonly tabindex: -1;
    ...
    options: {
        ...
        closeOnEscape: WithGet<import("svelte/store").Writable<boolean>>;
        closeOnOutsideClick: WithGet<import("svelte/store").Writable<boolean>>;
        portal: WithGet<import("svelte/store").Writable<string | HTMLElement | null | undefined>>;
