...
export declare function setCtx(props: CreateDropdownMenuProps): {
    ...
    options: {
        ...
        closeFocus: import("@melt-ui/svelte/internal/helpers").WithGet<import("svelte/store").Writable<import("@melt-ui/svelte/index.js").FocusProp | undefined>>;
        ...
        onOutsideClick: import("@melt-ui/svelte/internal/helpers").WithGet<import("svelte/store").Writable<((event: import("@melt-ui/svelte/index.js").InteractOutsideEvent) => void) | undefined>>;
    };
};
