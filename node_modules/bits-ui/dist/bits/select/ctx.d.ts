...
export declare function setCtx<T = unknown, M extends boolean = false>(props: Props<T, M>): {
    ...
    elements: {
        ...
        option: import("@melt-ui/svelte/internal/helpers").MeltElement<[import("svelte/store").Readable<(value: unknown) => boolean>], (node: HTMLElement) => import("@melt-ui/svelte/internal/types").MeltActionReturn<"click" | "pointermove">, ([$isSelected]: [(value: unknown) => boolean]) => (props: import("@melt-ui/svelte/index.js").SelectOptionProps<unknown>) => {
    ...
    states: {
        ...
        highlighted: import("svelte/store").Readable<import("@melt-ui/svelte/index.js").SelectOption<unknown> | undefined>;
